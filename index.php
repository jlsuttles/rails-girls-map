    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        ...
        <div class="left">
          ...
          <div class="buttons">
            <a href="#modal_info" class="btn btn-large btn-danger" data-toggle="modal"><i class="icon-info-sign icon-white"></i>About this Map</a>
            <?php if($sg_enabled) { ?>
              <a href="#modal_add_choose" class="btn btn-large btn-danger" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Add Something</a>
            <? } else { ?>
              <a href="#modal_add" class="btn btn-large btn-danger" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Add Something</a>
            <? } ?>
          </div>
          <div class="search">
